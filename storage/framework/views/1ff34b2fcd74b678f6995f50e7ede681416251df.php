<div id="card_wrapper">
    ...
    <div class="container">
        <div class="jumbotron text-center">
            <h1 id="title" data-title="<?php echo e($bet_amount->id); ?>"><?php echo e($bet_amount->title); ?></h1>
            <h4 id="amount" data-amount="<?php echo e($bet_amount->bet_amount); ?>">Amount: Php <span style="color:green;"><?php echo e(number_format($bet_amount->bet_amount,2)); ?></span> per bet</h4>
            <h4>Grand Price: <?php echo e($price->grandprice); ?></h4>
            <h4>Date: <?php echo e(date('Y-m-d h:i A',strtotime($bet_amount->date))); ?></h4>
            <h5>Balance: Php 
                <?php 
